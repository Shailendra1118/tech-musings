...
@Slf4j
public class PremiumCustomerMinDiscountCalculator implements DiscountCalculator {

    private DiscountCalculator nextDiscountCalculator;
    private static final AmountSlab slab = AmountSlab.builder().startAmt(0).endAmt(4000)
    ...
    public double calculate(PurchaseDetails purchaseDetails, double discountAmtTillNow) {
        ...
        if(purchaseDetails.getAmount() >= slab.getEndAmt()){
            ...
            log.info("Discount with 4K Slab={}", discountHere);
